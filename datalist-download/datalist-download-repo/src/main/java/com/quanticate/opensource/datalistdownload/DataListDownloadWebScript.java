        ...
        implements InitializingBean 
{
    ...
    protected List<Pair<QName, Boolean>> buildPropertiesForHeader(
       ...
       else
       {
          ...
          for (QName aspect : typeDef.getDefaultAspectNames()) {
        	  allProps = dictionaryService.getAspect(aspect).getProperties();
    ...
    protected void populateBody(Object resource, Workbook workbook,
       ...
       styleDate.setDataFormat( formatter.getFormat("dd/mm/yyyy") );
